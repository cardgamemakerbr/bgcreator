...
urlpatterns = [
    ...
    path('gerenciamento/usuario/novo/', views.usuario_novo, name='usuario_novo'),
    path('gerenciamento/usuario/editar/<int:user_id>/', views.usuario_editar, name='usuario_editar'),
    path('gerenciamento/usuario/excluir/<int:user_id>/', views.usuario_excluir, name='usuario_excluir'),
    path('gerenciamento/usuario/bloquear/<int:user_id>/', views.usuario_bloquear, name='usuario_bloquear'),
    path('gerenciamento/backup/download/<str:filename>/', views.backup_download, name='backup_download'),
    path('gerenciamento/backup/delete/<str:filename>/', views.backup_delete, name='backup_delete'),
